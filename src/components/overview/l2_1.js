...
import overview_l2A from '../../mock/overview_l2A';
import axios from 'axios';
import API from '../api';
import echObj from './echObj/l2A';
import { Radio } from 'antd';


export default class ComponentOvL2A extends React.Component{
  ...
  getData(tab){
    let that = this;
    axios.get(API().l2A).then(function (response) {
